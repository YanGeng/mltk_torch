...
from dataloader import TextDataset, BatchTextCall, TextDatasetMultLabel
...
#                                   collate_fn=train_dataset_call)
    ...
    test_dataloader = DataLoader(test_dataset, batch_size=config.batch_size, shuffle=True, num_workers=0,
                                 collate_fn=train_dataset_call)
...
#                 net_dict = accelerator.get_state_dict(multi_classification_model)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config", type=str, default="./config_multilabel_bert.yaml")
